...
void SSAO::CreateSSAOTexture(ID3D12Device* device)
{
	...
	desc.MipLevels = 1;
	desc.Format = DXGI_FORMAT_R8_UNORM;  // SSAO는 grayscale
...
// ============================================================================
// 2. View Space G-Buffer 생성 (Normal + Position)
// ============================================================================
...
// ============================================================================
// 4. Descriptor Heaps 생성
// ============================================================================

void SSAO::CreateDescriptorHeaps(ID3D12Device* device)
{
	// === RTV Heap (3개: SSAO + ViewNormal + ViewPosition) ===
	...
	// === SRV Heap (4개: SSAO + ViewNormal + ViewPosition + Random) ===
...
// ============================================================================
// 7. Offset Vectors 생성 (Frank Luna 방식)
// ============================================================================
