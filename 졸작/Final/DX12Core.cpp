...
void DX12Core::CreateDeferredRenderingDescriptors()
{
	...
	srvHeapDesc.NumDescriptors = 5; // Gbuffer(4) + shadow(1)
...
void DX12Core::BeginShadowPass()
{
	...
	XMVECTOR lightPos = XMVectorSet(playerCurrentPos.x + 9.0f, playerCurrentPos.y + 8.f, playerCurrentPos.z + 12.0f, 1);  // 높은 위치
