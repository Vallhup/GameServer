...
static const float VF_MAX_DISTANCE = 80.0f;                         // 최대 거리
static const float VF_JITTER_STRENGTH = 0.5f;                       // Banding 완화용

static const float VF_HEIGHT_FALLOFF = 0.001f;                      // 높이 감쇠 계수
static const float VF_GROUND_HEIGHT = 5.0f;                         // 기준 높이

static const float3 VF_LIGHT_COLOR = float3(1.0f, 0.95f, 0.8f);     // 안개 속 빛 색상
