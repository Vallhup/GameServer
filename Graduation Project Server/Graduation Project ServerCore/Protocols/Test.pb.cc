...
const ::uint32_t
    TableStruct_Test_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        PROTOBUF_FIELD_OFFSET(::Protocol::Test, _impl_.attack_),
        PROTOBUF_FIELD_OFFSET(::Protocol::Test, _impl_.buffs_),
};
...
const char descriptor_table_protodef_Test_2eproto[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
    ...
    "\022\016\n\006attack\030\003 \001(\r\022!\n\005buffs\030\004 \003(\0132\022.Protoc"
    "ol.BuffDatab\006proto3"
};
...
inline PROTOBUF_NDEBUG_INLINE Test::Impl_::Impl_(
    ...
    const Impl_& from, const ::Protocol::Test& from_msg)
...
constexpr auto Test::InternalNewImpl_() {
  constexpr auto arena_bits = ::google::protobuf::internal::EncodePlacementArenaOffsets({
      PROTOBUF_FIELD_OFFSET(Test, _impl_.buffs_) +
          decltype(Test::_impl_.buffs_)::
...
const ::_pbi::TcParseTable<2, 4, 1, 0, 2> Test::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    {::_pbi::TcParser::FastMtR1,
     {34, 63, 0, PROTOBUF_FIELD_OFFSET(Test, _impl_.buffs_)}},
    // uint64 id = 1;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint64_t, offsetof(Test, _impl_.id_), 63>(),
     {8, 63, 0, PROTOBUF_FIELD_OFFSET(Test, _impl_.id_)}},
    // uint32 hp = 2;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(Test, _impl_.hp_), 63>(),
     {16, 63, 0, PROTOBUF_FIELD_OFFSET(Test, _impl_.hp_)}},
    // uint32 attack = 3;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(Test, _impl_.attack_), 63>(),
     {24, 63, 0, PROTOBUF_FIELD_OFFSET(Test, _impl_.attack_)}},
  }}, {{
    65535, 65535
  }}, {{
    // uint64 id = 1;
    ...
    // uint32 hp = 2;
    {PROTOBUF_FIELD_OFFSET(Test, _impl_.hp_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUInt32)},
    // uint32 attack = 3;
    {PROTOBUF_FIELD_OFFSET(Test, _impl_.attack_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kUInt32)},
    // repeated .Protocol.BuffData buffs = 4;
    {PROTOBUF_FIELD_OFFSET(Test, _impl_.buffs_), 0, 0,
...
void Test::InternalSwap(Test* PROTOBUF_RESTRICT other) {
  ...
  ::google::protobuf::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Test, _impl_.attack_)
      + sizeof(Test::_impl_.attack_)
